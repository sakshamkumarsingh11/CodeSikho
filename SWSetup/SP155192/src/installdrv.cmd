...
if %PROCESSOR_ARCHITECTURE%==AMD64 (
    ...
    set DriverSrcPath="%~dp0Drivers\RTWLANE_Driver\Win10X64"
    set DPInstPath="%~dp0Drivers\RTWLANE_Driver\DPInst\X64"
)

set VersionPath="%~dp0Drivers\RTWLANE_Driver\Version"
set var=%WiFiDIR:~1,-1%
...
xcopy /y "%~dp0Drivers\RTWLANE_Driver\Win10X64\*" "%var%\RTWLANE_Driver\Win10X64\" /s > nul
xcopy /y "%~dp0Drivers\RTWLANE_Driver\DPInst\*" "%var%\RTWLANE_Driver\DPInst\" /s > nul
